...
const firebaseConfig = {
  ...
  alert("your in room :" + room_name)
  document.getElementById("room_name").innnerHTML = room_name;
...
//Start code
    ...
    name_with_tag = "<h4> "+ name +"<img class='user_tick' src='https://th.bing.com/th/id/OIP.VnFUQXnT_YolB-tAOociBgHaHw?pid=ImgDet&rs=1'></h4>";
